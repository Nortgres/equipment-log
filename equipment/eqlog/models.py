...
class Equipment(models.Model):
    ...
    serial_number = models.CharField(verbose_name='Модель', max_length=50)
    id_number = models.CharField(verbose_name='Инвентарный номер', max_length=10)
    sale_date = models.DateField(verbose_name='Дата покупки', default=date(2000, 1, 1))
...
class Person(models.Model):
    ...
    created_at = models.DateTimeField(verbose_name='Дата создания', auto_now_add=True)
    updated_at = models.DateTimeField(verbose_name='Дата изменения', auto_now=True)
    is_working = models.BooleanField(verbose_name='Учится', default=True)
    slug = models.SlugField(verbose_name='URL', max_length=255, unique=True, db_index=True)
    objects = models.Manager()
